        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex flex-col items-end gap-1">
            <button
              type="button"
              onClick={handleBook}
              className="inline-flex items-center gap-1 rounded-full bg-gradient-to-tr from-[#FF6B35] via-[#F7931E] to-[#D4AF37] px-3 py-1.5 text-[11px] font-semibold text-white shadow-sm"
            >
              Book this pooja
            </button>
            <button
              ...
              className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-white/80 px-3 py-1 text-[11px] font-semibold text-slate-700 hover:bg-slate-50"
            >
              View details
